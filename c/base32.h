...
/*
encodes 'plain' bytes as base32 into 'encoded', appending a null character at the end
...
/*
decodes 'encoded' bytes as base32 into 'plain', appending a null character at the end
